...
import ProgressBarCell from './templates/progress-bar-cell.jsx';
import HighlightedCell from './templates/highlighted-cell.jsx';
...
class UncontrolledModeDemo extends React.PureComponent {
    constructor(props) {
        super(props);
...
export default UncontrolledModeDemo;